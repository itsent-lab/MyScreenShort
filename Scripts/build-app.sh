...
<dict>
    ...
    <string>io.github.itsent-lab.MyScreenShort</string>
...
codesign --force --deep --sign - --requirements '=designated => identifier "io.github.itsent-lab.MyScreenShort"' "$APP_DIR"
